...
<script type="text/javascript">
    $(function () {
        ...
        $("#searchBtn").click(function () {
            // 1.获取关键词数据赋值给全局变量
            window.keyword1 = $("#id").val();
            window.keyword2 = $("#name").val();
            // 2,调用分页函数刷新页面
            generatePage();
        });
...
// ③关闭模态框
        ...
        $("#removeRoleBtn").click(function () {
            ...
            var ids = JSON.stringify(window.roleIdArray);
                    ...
                    <form class="form-inline" role="form" style="float:left;">
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input id="id" class="form-control has-success" type="text"
                                       placeholder="请输入查询条件">
                            </div>
                        </div>
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input id="name" class="form-control has-success" type="text"
                                       placeholder="请输入查询条件">
                            </div>
                        </div>
