                    ...
                    <form action="admin/get/page.html" class="form-inline" role="form" style="float:left;">
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input name="loginAcct" class="form-control has-success" type="text" placeholder="请输入查询条件">
                            </div>
                        </div>
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                <div class="input-group-addon">姓名</div>
                                <input name="userName" class="form-control has-success" type="text" placeholder="请输入查询条件">
                            </div>
                        </div>
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                <div class="input-group-addon">Email</div>
                                <input name="email" class="form-control has-success" type="text" placeholder="请输入查询条件">
                            </div>
                        </div>
